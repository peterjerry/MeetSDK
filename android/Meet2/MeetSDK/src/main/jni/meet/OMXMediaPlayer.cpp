...
OMXMediaPlayerListener::OMXMediaPlayerListener(JNIEnv* env, jobject thiz, jobject weak_thiz)
{
	...
	if (clazz == NULL) {
		PPLOGE("Can't find com/gotye/meetsdk/player/OMXMediaPlayer");
...
/* Header for class com_gotye_meetsdk_player_OMXPlayer */

#ifndef _Included_com_gotye_meetsdk_player_OMXPlayer
#define _Included_com_gotye_meetsdk_player_OMXPlayer
#ifdef __cplusplus
extern "C" {
#endif
...
jboolean android_media_omxmediaplayer_init(JNIEnv *env, jobject thiz)
{
	...
	jclass clazz = env->FindClass("com/gotye/meetsdk/player/OMXMediaPlayer");
	if (clazz == NULL)
		jniThrowException(env, "java/lang/RuntimeException", "Can't find com/gotye/meetsdk/player/OMXMediaPlayer");
