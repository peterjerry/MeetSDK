...
#define FFMPEG_CONFIGURATION "--prefix=/e/git/PPTV/MeetSDK/foundation/build/win32/../../output/win32/lite --toolchain=icl --arch=i686 --enable-shared --disable-static --enable-w32threads --enable-optimizations --extra-cflags='-DNDEBUG -march=i686 -Z7 -DX264_API_IMPORTS -I/e/git/PPTV/MeetSDK/foundation/build/win32/msinttypes' --extra-ldflags=-DEBUG --optflags=-O2 --disable-doc --disable-avdevice --disable-dxva2 --disable-swscale-alpha --disable-encoders --disable-muxers --disable-devices --disable-asm --disable-symver --disable-decoders --enable-decoder='h263,h264,hevc,vp3,vp5,vp6,vp6a,vp6f,vp7,vp8,vp9,flv,mpegvideo,mpeg1video,mpeg2video,mpeg4,ac3,eac3,aac,dca,mp1,mp2,mp3,rv30,rv40,cook,wmv1,wmv2,wmv3,wmv3image,vorbis,ape,flac,wmav1,wmav2,wmapro,mjpeg,msmpeg4v1,msmpeg4v2,msmpeg4v3,amrnb,amrwb,pcm_s16be,pcm_s16be_planar,pcm_s16le,pcm_s16le_planar,ass,dvbsub,dvdsub,mov_text,sami,srt,ssa,subrip,text' --disable-demuxers --enable-demuxer='rm,mpegvideo,mjpeg,avi,h263,h264,hevc,matroska,dts,dtshd,aac,flv,mpegts,mpegps,mp4,m4v,mov,ape,hls,flac,rawvideo,realtext,rtsp,vc1,mp3,wav,asf,ogg' --disable-parsers --enable-parser='h263,h264,hevc,mpegaudio,mpegvideo,aac_latm,mpeg4video,dca,aac,ac3,eac3,flac,png,bmp,rv30,rv40,cavsvideo,vc1,vorbis,mjpeg,vp3,vp8,vp9,cook'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2014
#define FFMPEG_DATADIR "/e/git/PPTV/MeetSDK/foundation/build/win32/../../output/win32/lite/share/ffmpeg"
#define AVCONV_DATADIR "/e/git/PPTV/MeetSDK/foundation/build/win32/../../output/win32/lite/share/ffmpeg"
#define CC_IDENT "Intel(R) C++ Compiler XE for applications running on IA-32, Version 13.0.1.119 Build 20121008"
...
#define CONFIG_LIBLENTHEVCDEC 0
#define CONFIG_LIBLENTHEVCENC 0
...
#define CONFIG_LIBLENTHEVCHM91_DECODER 0
#define CONFIG_LIBLENTHEVCHM10_DECODER 0
#define CONFIG_LIBLENTHEVC_DECODER 0
...
#define CONFIG_LIBLENTHEVCHM91_ENCODER 0
#define CONFIG_LIBLENTHEVCHM10_ENCODER 0
#define CONFIG_LIBLENTHEVC_ENCODER 0
