...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/e/git/PPTV/MeetSDK/foundation/build/win32/../../output/win32/lite --toolchain=icl --arch=i686 --enable-shared --disable-static --enable-w32threads --enable-optimizations --extra-cflags='-DNDEBUG -march=i686 -Z7 -DX264_API_IMPORTS -I/e/git/PPTV/MeetSDK/foundation/build/win32/msinttypes' --extra-ldflags=-DEBUG --optflags=-O2 --disable-doc --disable-avdevice --disable-dxva2 --disable-swscale-alpha --disable-encoders --disable-muxers --disable-devices --disable-asm --disable-symver --disable-decoders --enable-decoder='h263,h264,hevc,vp3,vp5,vp6,vp6a,vp6f,vp7,vp8,vp9,flv,mpegvideo,mpeg1video,mpeg2video,mpeg4,ac3,eac3,aac,dca,mp1,mp2,mp3,rv30,rv40,cook,wmv1,wmv2,wmv3,wmv3image,vorbis,ape,flac,wmav1,wmav2,wmapro,mjpeg,msmpeg4v1,msmpeg4v2,msmpeg4v3,amrnb,amrwb,pcm_s16be,pcm_s16be_planar,pcm_s16le,pcm_s16le_planar,ass,dvbsub,dvdsub,mov_text,sami,srt,ssa,subrip,text' --disable-demuxers --enable-demuxer='rm,mpegvideo,mjpeg,avi,h263,h264,hevc,matroska,dts,dtshd,aac,flv,mpegts,mpegps,mp4,m4v,mov,ape,hls,flac,rawvideo,realtext,rtsp,vc1,mp3,wav,asf,ogg' --disable-parsers --enable-parser='h263,h264,hevc,mpegaudio,mpegvideo,aac_latm,mpeg4video,dca,aac,ac3,eac3,flac,png,bmp,rv30,rv40,cavsvideo,vc1,vorbis,mjpeg,vp3,vp8,vp9,cook'
prefix=/e/git/PPTV/MeetSDK/foundation/build/win32/../../output/win32/lite
...
CC_IDENT=Intel(R) C++ Compiler XE for applications running on IA-32, Version 13.0.1.119 Build 20121008
ARCH=c
CC=icl
CXX=g++
AS=icl
...
CFLAGS= -nologo -Qdiag-error:4044,10157 -D_USE_MATH_DEFINES -FIstdlib.h -Dstrtoll=_strtoi64 -Qms0 -Qvec- -Qsimd- -GS -fp:precise -DNDEBUG -Z7 -DX264_API_IMPORTS -I/e/git/PPTV/MeetSDK/foundation/build/win32/msinttypes -Qstd=c99  -Z7 -Wall -Qdiag-disable:remark -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O2   -Oy-
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -nologo -Qdiag-error:4044,10157 -D_USE_MATH_DEFINES -FIstdlib.h -Dstrtoll=_strtoi64 -Qms0 -Qvec- -Qsimd- -GS -fp:precise -DNDEBUG -Z7 -DX264_API_IMPORTS -I/e/git/PPTV/MeetSDK/foundation/build/win32/msinttypes -Z7
AS_C=-c
AS_O=-Fo$@
CC_C=-c
CC_E=-P
...
WINDRES=windres
DEPWINDRES=icl
LDFLAGS= -DEBUG -nologo  -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -debug
SHFLAGS=-dll -def:$$(@:$(SLIBSUF)=.def) -implib:$(SUBDIR)$(SLIBNAME:$(SLIBSUF)=.lib) -Wl,-Bsymbolic -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
ASMSTRIPFLAGS=
YASMFLAGS=
BUILDSUF=
PROGSSUF=
...
ASDEP=
ASDEP_FLAGS=
CC_DEPFLAGS=-QMMD -QMF$(@:.o=.d) -QMT$@
AS_DEPFLAGS=-QMMD -QMF$(@:.o=.d) -QMT$@
HOSTCC=icl
HOSTLD=icl
HOSTCFLAGS= -nologo -Qdiag-error:4044,10157 -D_USE_MATH_DEFINES -FIstdlib.h -Dstrtoll=_strtoi64 -Qms0 -Qvec- -Qsimd- -GS -fp:precise -Dsnprintf=_snprintf -Qstd=c99 -Wall -Qdiag-disable:remark -O3
HOSTCPPFLAGS= -D_ISOC99_SOURCE -D_WIN32_WINNT=0x0502
HOSTEXESUF=.exe
HOSTLDFLAGS= -nologo -Qdiag-error:4044,10157
HOSTLIBS=-lm
DEPHOSTCC=icl
DEPHOSTCCFLAGS= $(HOSTCCFLAGS)
HOSTCCDEP=
HOSTCCDEP_FLAGS=
HOSTCC_DEPFLAGS=-QMMD -QMF$(@:.o=.d) -QMT$@
HOSTCC_C=-c
HOSTCC_O=-Fo$@
HOSTLD_O=-Fe$@
TARGET_EXEC= 
...
CFLAGS-ffplay=-I/usr/include/SDL -D_GNU_SOURCE=1 -Dmain=SDL_main
ZLIB=zlib.lib
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=ws2_32.lib psapi.lib advapi32.lib shell32.lib 
...
LIBS-ffplay=-L/usr/lib -lmingw32 -lSDLmain -lSDL
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=
!ARCH_AARCH64=yes
...
!CONFIG_LIBX264=yes
!CONFIG_LIBX265=yes
!CONFIG_LIBLENTHEVCDEC=yes
!CONFIG_LIBLENTHEVCENC=yes
!CONFIG_LIBXAVS=yes
!CONFIG_LIBXVID=yes
!CONFIG_LIBZMQ=yes
!CONFIG_LIBZVBI=yes
...
!CONFIG_LIBLENTHEVCHM91_DECODER=yes
!CONFIG_LIBLENTHEVCHM10_DECODER=yes
!CONFIG_LIBLENTHEVC_DECODER=yes
...
!CONFIG_LIBLENTHEVCHM91_ENCODER=yes
!CONFIG_LIBLENTHEVCHM10_ENCODER=yes
!CONFIG_LIBLENTHEVC_ENCODER=yes
