...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=i386 --cpu=i386 --target-os=darwin --enable-cross-compile --cc='/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc -arch i386' --sysroot=/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk --extra-ldflags=-L/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk/usr/lib/system --extra-cflags='-DOS_IOS -arch i386' --enable-pic --disable-doc --disable-symver --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-postproc --disable-avfilter --disable-swscale-alpha --disable-encoders --disable-muxers --disable-parser=mlp --disable-demuxer=mlp --disable-decoder=mlp --disable-devices --disable-filters --disable-vfp --disable-fast-unaligned --disable-debug --disable-asm --disable-decoder='ac3,eac3' --disable-parser=ac3 --disable-demuxer='ac3,eac3'
prefix=/usr/local
...
ARCH=c
CC=/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc -arch i386
CXX=g++
AS=/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc -arch i386
LD=/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc -arch i386
DEPCC=/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc -arch i386
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc -arch i386
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk -isysroot /Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=  -DOS_IOS -arch i386 -march=i386 -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -msse2 -msse3 -msse4 -mllvm -stack-alignment=16
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -DOS_IOS -arch i386 -march=i386 -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc -arch i386
LDFLAGS= -L/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk/usr/lib/system  --sysroot=/Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk -isysroot /Applications/Xcode4.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk -Wl,-dynamic,-search_paths_first
