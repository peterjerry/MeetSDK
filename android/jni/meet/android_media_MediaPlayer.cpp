...
JNIMediaPlayerListener::JNIMediaPlayerListener(JNIEnv* env, jobject thiz, jobject weak_thiz)
{
	...
	if (clazz == NULL) {
		PPLOGE("Can't find android/pplive/media/player/NativeMediaPlayer");
...
void android_media_MediaPlayer_native_init(JNIEnv *env, jobject thiz, jboolean startP2PEngine)
{
	...
	if (clazz == NULL)
		jniThrowException(env, "java/lang/RuntimeException", "Can't find android/pplive/media/player/NativeMediaPlayer");
...
static JNINativeMethod gMethods[] = {
	...
	{"selectAudioChannel",  "(I)V",					(void *)android_media_MediaPlayer_selectAudioChannel},
