...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/e/svn/meet/engine2/foundation/build/icl/../../output/icl --toolchain=icl --arch=i686 --enable-shared --disable-static --enable-w32threads --enable-optimizations --extra-cflags='-DNDEBUG -march=i686 -Z7 -DX264_API_IMPORTS -I/e/svn/meet/engine2/foundation/build/icl/msinttypes' --extra-ldflags=-DEBUG --optflags=-O2 --disable-doc --disable-programs --disable-avdevice --disable-swscale-alpha --disable-asm --disable-symver --disable-decoders --enable-decoder='h263,h264,hevc,flv,mpeg1video,mpeg2video,mpeg4,ac3,aac,mp1,mp2,mp3,cook,rv40' --disable-encoders --disable-demuxers --enable-demuxer='rm,mpegvideo,avi,h263,h264,hevc,mkv,aac,flv,mpegts,mp4,mov,ape,hls,rtsp,rtp,sdp,asf' --disable-muxers --disable-parsers --enable-parser='h263,h264,hevc,vp8,mpegaudio,mpeg4video,aac,ac3' --disable-devices
prefix=/e/svn/meet/engine2/foundation/build/icl/../../output/icl
...
CFLAGS= -nologo -Qdiag-error:4044,10157 -D_USE_MATH_DEFINES -FIstdlib.h -Dstrtoll=_strtoi64 -Qms0 -Qvec- -Qsimd- -GS -fp:precise -DNDEBUG -Z7 -DX264_API_IMPORTS -I/e/svn/meet/engine2/foundation/build/icl/msinttypes -Qstd=c99  -Z7 -Wall -Qdiag-disable:remark -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O2   -Oy-
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -nologo -Qdiag-error:4044,10157 -D_USE_MATH_DEFINES -FIstdlib.h -Dstrtoll=_strtoi64 -Qms0 -Qvec- -Qsimd- -GS -fp:precise -DNDEBUG -Z7 -DX264_API_IMPORTS -I/e/svn/meet/engine2/foundation/build/icl/msinttypes -Z7
AS_C=-c
AS_O=-Fo$@
CC_C=-c
CC_E=-P
