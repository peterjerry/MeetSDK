...
FFMPEG_URL="http://jenkins/view/Meet/job/ffmpeg_ios_git/5/artifact/foundation/output/ios/v8/libffmpeg_univernal_full_1.0.2.5.zip"
FFMPEG_ZIP="ffmpeg.zip"
SUBTITLE_URL="http://jenkins/view/Meet/job/subtitle2_ios_git/9/artifact/subtitle2/build/ios/output/subtitle2_univernal_1.0.2.9.zip"
