...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=x86 --cpu=i686 --target-os=linux --enable-optimizations --enable-cross-compile --cross-prefix='D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-' --sysroot='D:/Software/android-ndk-r9d/platforms/android-9/arch-x86' --extra-cflags='-DNDEBUG -mandroid -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -funswitch-loops -finline-limit=300 -finline-functions -fpredictive-commoning -fgcse-after-reload -fipa-cp-clone -march=i686 -msse4 -fstrict-aliasing' --extra-ldflags= --optflags='-O2 -fno-pic' --enable-zlib --enable-pic --disable-doc --disable-symver --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-postproc --disable-avfilter --disable-swscale-alpha --disable-encoders --disable-muxers --disable-devices --disable-filters --disable-vfp --disable-debug --disable-fast-unaligned
prefix=/usr/local
...
ARCH=x86
CC=D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-gcc
CXX=D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-g++
AS=D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-gcc
LD=D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-gcc
DEPCC=D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-ar
ARFLAGS=rc
AR_O=$@
RANLIB=D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-ranlib
STRIP=D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=D:/Software/android-ndk-r9d/platforms/android-9/arch-x86 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
CFLAGS=  -DNDEBUG -mandroid -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -funswitch-loops -finline-limit=300 -finline-functions -fpredictive-commoning -fgcse-after-reload -fipa-cp-clone -march=i686 -msse4 -fstrict-aliasing -march=i686 -std=c99 -fomit-frame-pointer -fPIC -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O2 -fno-pic -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -DNDEBUG -mandroid -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -funswitch-loops -finline-limit=300 -finline-functions -fpredictive-commoning -fgcse-after-reload -fipa-cp-clone -march=i686 -msse4 -fstrict-aliasing -march=i686 -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=   --sysroot=D:/Software/android-ndk-r9d/platforms/android-9/arch-x86 -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
libavfilter_VERSION=3.89.100
libavfilter_VERSION_MAJOR=3
libavfilter_VERSION_MINOR=89
libavformat_VERSION=55.19.103
