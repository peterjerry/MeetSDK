...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=arm --cpu=armv7-a --target-os=linux --enable-optimizations --enable-cross-compile --cross-prefix='D:/Software/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-' --sysroot='D:/Software/android-ndk-r9d/platforms/android-9/arch-arm' --extra-cflags='-DNDEBUG -mandroid -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -funswitch-loops -finline-limit=300 -finline-functions -fpredictive-commoning -fgcse-after-reload -fipa-cp-clone -mfloat-abi=softfp -mfpu=neon -mtune=cortex-a8 -mvectorize-with-neon-quad -fstack-protector -fstrict-aliasing' --extra-ldflags='-Wl,--fix-cortex-a8' --optflags=-O2 --enable-zlib --enable-pic --disable-doc --disable-symver --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-postproc --disable-avfilter --disable-swscale-alpha --disable-encoders --disable-muxers --disable-devices --disable-filters --disable-vfp --disable-debug --disable-fast-unaligned --disable-armv6 --disable-armv6t2
prefix=/usr/local
...
CXX=D:/Software/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-g++
AS=D:/Software/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-gcc
LD=D:/Software/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCC=D:/Software/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=D:/Software/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=D:/Software/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=D:/Software/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-ranlib
STRIP=D:/Software/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=D:/Software/android-ndk-r9d/platforms/android-9/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -Wl,--fix-cortex-a8  --sysroot=D:/Software/android-ndk-r9d/platforms/android-9/arch-arm -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
