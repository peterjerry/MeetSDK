...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/e/git/PPTV/MeetSDK/foundation/build/win32/../../output/win32/full --toolchain=icl --arch=i686 --enable-shared --disable-static --enable-w32threads --enable-optimizations --extra-cflags='-DNDEBUG -march=i686 -Z7 -DX264_API_IMPORTS -I/e/git/PPTV/MeetSDK/foundation/build/win32/msinttypes' --extra-ldflags=-DEBUG --optflags=-O2 --disable-doc --disable-programs --disable-avdevice --disable-swscale-alpha --disable-asm --disable-symver
prefix=/e/git/PPTV/MeetSDK/foundation/build/win32/../../output/win32/full
