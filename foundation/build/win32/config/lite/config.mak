...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/e/git/PPTV/MeetSDK/foundation/build/win32/../../output/win32/lite --toolchain=icl --arch=i686 --enable-shared --disable-static --enable-w32threads --enable-optimizations --extra-cflags='-DNDEBUG -march=i686 -Z7 -DX264_API_IMPORTS -I/e/git/PPTV/MeetSDK/foundation/build/win32/msinttypes' --extra-ldflags=-DEBUG --optflags=-O2 --disable-doc --disable-programs --disable-avdevice --disable-swscale-alpha --disable-asm --disable-symver --disable-decoders --enable-decoder='h263,h264,hevc,vp8,vp9,mjpeg,flv,mpeg1video,mpeg2video,mpeg4,ac3,aac,mp1,mp2,mp3,rv30,rv40,cook,wmv1,wmv2,wmv3,wmv3image,vorbis,ape,flac,wmav1,wmav2,wmapro,amrnb,amrwb,pcm_s16be,pcm_s16be_planar,pcm_s16le,pcm_s16le_planar,ass,dvbsub,dvdsub,mov_text,sami,srt,ssa,subrip,text' --disable-demuxers --enable-demuxer='rm,mpegvideo,avi,h263,h264,mjpeg,hevc,matroska,aac,flv,mpegts,mp4,m4v,mov,ape,hls,flac,rawvideo,realtext,rtsp,vc1,mp3,wav,asf' --disable-parsers --enable-parser='h263,h264,hevc,vp8,mpegaudio,mpegvideo,aac_latm,mpeg4video,aac,ac3,flac,png,bmp,rv30,rv40,cavsvideo,vc1,vorbis,mjpeg,vp8,vp9,cook'
