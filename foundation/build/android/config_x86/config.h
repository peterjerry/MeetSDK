...
#define FFMPEG_CONFIGURATION "--arch=x86 --cpu=i686 --target-os=linux --enable-optimizations --enable-cross-compile --cross-prefix='D:/Software/android-ndk-r9d/toolchains/x86-4.8/prebuilt/windows/bin/i686-linux-android-' --sysroot='D:/Software/android-ndk-r9d/platforms/android-9/arch-x86' --extra-cflags='-DNDEBUG -mandroid -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -funswitch-loops -finline-limit=300 -finline-functions -fpredictive-commoning -fgcse-after-reload -fipa-cp-clone -march=i686 -msse4 -fstrict-aliasing' --extra-ldflags= --optflags='-O2 -fno-pic' --enable-zlib --enable-pic --disable-doc --disable-symver --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-postproc --disable-avfilter --disable-swscale-alpha --disable-encoders --disable-muxers --disable-devices --disable-filters --disable-vfp --disable-debug --disable-fast-unaligned"
