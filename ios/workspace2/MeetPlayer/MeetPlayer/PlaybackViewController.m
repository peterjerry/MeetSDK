...
{
    NSString *msg = [NSString stringWithFormat:@"Type: %@", [player_ playerType]==PPMOVIE_SYSTEM_PLAYER ? @"system player" : @"pp player"];
    //NSString *msg1 = [NSString stringWithFormat:@"Url: %@", [url_ absoluteString]];
    NSString *msg2 = [NSString stringWithFormat:@"Duration: %.3f sec", player_.duration];
    NSString *msg3 = [NSString stringWithFormat:@"Size: %.0f * %.0f", player_.size.width, player_.size.height];
    NSString *msg4 = [NSString stringWithFormat:@"bytes trans: %lld", [player_ numberOfBytesTransfered]];
    NSString *msg5 = [NSString stringWithFormat:@"buffering time: %.0f", player_.bufferingTime];
